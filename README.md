...
## Актуальные backend-направления

- Team Finder / Opportunities: структурированные запросы на поиск людей в команду
  с ролями, навыками, дедлайном, размером команды, откликами, приглашениями,
  статусами и уведомлениями.
- Privacy-safe fingerprint удалённого email против повторной регистрации и обхода
