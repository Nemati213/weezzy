...
5. Matching worker и создание extension offer — реализовано; lifecycle продолжается:
   ...
   - осталось реализовать таймаут, `EXPIRED`, лимит продлений и завершение групп.
