...
6. Добавить оставшуюся transactional outbox-интеграцию:
   - событие системной отмены группы;
   - новые notification types, payloads и handlers с идемпотентной доставкой.
7. Добавить API и lifecycle группы:
   - получение текущей группы и её участников;
   - доступ только участникам;
   - `ACTIVE`, `COMPLETED`, `CANCELLED` и правила системной отмены;
