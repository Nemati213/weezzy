...
На текущий момент критичные активные задачи не зафиксированы. Добавлять в этот раздел
только задачи, которые действительно блокируют основной пользовательский сценарий,
безопасность или выпуск сервиса.
