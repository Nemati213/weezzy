...
5. Matching worker — реализовано; lifecycle workers — следующий этап:
   ...
   - осталось перевести несматченные заявки в `EXTENSION_REQUESTED`;
