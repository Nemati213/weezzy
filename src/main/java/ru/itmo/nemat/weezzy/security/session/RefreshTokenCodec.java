...
public class RefreshTokenCodec {
	...
	public Optional<ParsedRefreshToken> parse(String rawToken) {
		...
		try {
			...
			return Optional.of(new ParsedRefreshToken(tokenId, hash(secret)));
	...
	public record GeneratedRefreshToken(UUID id, String value, String secretHash) {
	}

	public record ParsedRefreshToken(UUID id, String secretHash) {
	}
}
